...
var textEndX = horizontalCenter + (dboxWidth/2) - 32;
...
if (dboxReady) {
	...
	//draw text
	draw_text_color(textStartX, boxTopY+(48 * currentline), message_draw,c_white,c_white,c_white,c_white,1); //draw the text at the coordinates
